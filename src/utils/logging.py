...
会話ログ形式:
  ...
  [YYYY-MM-DD HH:MM:SS] OBS  : 視覚観察メモ
  [YYYY-MM-DD HH:MM:SS] PLAN : intent=...
...
class ConversationLogger:
    ...
    def log_observation(self, text: str) -> None:
        self._write(f"[{self._ts()}] OBS  : {text}")

    def log_action_plan(self, intent: str, summary: str) -> None:
        self._write(f"[{self._ts()}] PLAN : intent={intent} {summary}")
